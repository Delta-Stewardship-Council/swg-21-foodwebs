...
psych::pairs.panels(dplyr::select(fdr, year, flow, temp, secchi, chla, hcope, clad, pcope, mysid, estfish, sside, clams, dophos),lm = T, bg=c("red","yellow","blue")[factor(fdr$region)],pch=21)
```

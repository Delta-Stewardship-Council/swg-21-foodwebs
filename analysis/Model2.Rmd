...
model2a='chla_dtr~flow_dtr+temp_dtr+secchi_dtr
         hzoop_dtr~flow_dtr+temp_dtr+secchi_dtr+chla_dtr+pcal_dtr
         pcal_dtr~flow_dtr+temp_dtr+secchi_dtr
         mysid_dtr~flow_dtr+temp_dtr+secchi_dtr+hzoop_dtr+pcal_dtr
         smelt_dtr~flow_dtr+temp_dtr+secchi_dtr+hzoop_dtr+pcal_dtr+mysid_dtr'
...
model2b='chla_dtr~flow_dtr+temp_dtr+secchi_dtr
         ...
         pcal_dtr~flow_dtr+temp_dtr+secchi_dtr
         mysid_dtr~flow_dtr+temp_dtr+secchi_dtr+hzoop_dtr+pcal_dtr
         estfish_dtr~flow_dtr+temp_dtr+secchi_dtr+hzoop_dtr+pcal_dtr+mysid_dtr'
...
model2c='chla_dtr~flow_dtr+temp_dtr+secchi_dtr
         ...
         pcal_dtr~flow_dtr+temp_dtr+secchi_dtr
         mysid_dtr~flow_dtr+temp_dtr+secchi_dtr+hzoop_dtr+pcal_dtr
         estfish_lat~flow_dtr+temp_dtr+secchi_dtr+hzoop_dtr+pcal_dtr+mysid_dtr
...
model2d='chla~year+flow+temp+secchi
         hzoop~year+flow+temp+secchi+chla+pcal
         pcal~year+flow+temp+secchi
         mysid~year+flow+temp+secchi+hzoop+pcal
         estfish_lat~year+flow+temp+secchi+hzoop+pcal+mysid

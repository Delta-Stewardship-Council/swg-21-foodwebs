...
upper_figure <- ggarrange(plotlist=upper_grobs, labels="auto",
  ...
  annotate_figure(top = text_grob("Monthly Regional Models (upper trophic level)",
                                  ...
                                  face = "bold",
                                  size = 14))
ggsave('./fig_output/sem_upper_trophic.tiff',upper_figure, width=7, height=7, dpi=600, bg = "white")
```
...
lower_figure <- ggarrange(plotlist=lower_grobs, labels="auto",
  ...
  annotate_figure(top = text_grob("Monthly Regional Models (lower trophic level)",
                                  ...
                                  face = "bold",
                                  size = 14))
ggsave('./fig_output/sem_lower_trophic.tiff',lower_figure, width=7, height=7, dpi=600, bg = "white")
```

...
modFW='fish=~estfish_bsmt+estfish_bsot
       fish~hcope_1+amphi_1+pcope_1+flow_1
       #estfish_bsmt~hcope_1+amphi_1+pcope_1+flow_1
       #estfish_bsot~hcope_1+amphi_1+pcope_1+flow_1
'
modW='estfish_bsmt~hcope_1+mysid_1+pcope_1+flow_1
      estfish_bsot~hcope_1+mysid_1+pcope_1+flow_1
'
modN='estfish_bsmt~hcope_1+amphi_1+pcope_1+flow_1
      estfish_bsot~hcope_1+amphi_1+pcope_1+flow_1
'
modS='estfish_bsmt~hcope_1+clad_1+pcope_1+flow_1
      estfish_bsot~hcope_1+clad_1+pcope_1+flow_1
'
modfitFW=sem(modFW, data=filter(fdr_ds,region=="Far West"))
modfitW=sem(modW, data=filter(fdr_ds,region=="West"))
modfitN=sem(modN, data=filter(fdr_ds,region=="North"))

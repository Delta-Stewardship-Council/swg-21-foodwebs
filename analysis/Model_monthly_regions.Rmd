...
ggsave('./fig_output/sem_upper_trophic.png',upper_figure,width=6,height=3, dpi = 300)
```
...
ggsave('./fig_output/sem_lower_trophic.png',lower_figure,width=6,height=3, dpi = 300)
```
...
ggsave('./fig_output/sem_zoop.png',zoop_figure.png,width=6,height=3, dpi = 300)
```

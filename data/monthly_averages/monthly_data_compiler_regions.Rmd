...
```{r}
amphipod=read.csv("data/monthly_averages/amphipod_monthly_regions.csv")
flow=read.csv("data/monthly_averages/monthly_average_flow_byregion.csv")
clams=read.csv("data/monthly_averages/clams_monthly_regions.csv")
fishbs=read.csv("data/monthly_averages/fish_BayStudy_monthly.csv")
fishdj=read.csv("data/monthly_averages/fish_DJFMP_monthly.csv")
nutwq=read.csv("data/monthly_averages/nutrient_data_monthly_regions_imputed.csv")
zoop=read.csv("data/monthly_averages/zoop_month.csv")

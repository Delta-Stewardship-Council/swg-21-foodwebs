...
BayStudy_annual_derived <- BayStudy_annual %>%
  ...
  mutate(Biomass = case_when(
    Taxa=="Hypomesus transpacificus" ~ (0.0018*(Length^3.38))*Count/1000,
    Taxa=="Spirinchus thaleichthys" ~ (0.0005*(Length^3.69))*Count/1000,
    Taxa=="Dorosoma petenense" ~ (0.0072*(Length^3.16))*Count/1000,
    Taxa=="Alosa sapidissima" ~ (0.0074*(Length^3.09))*Count/1000,
    Taxa=="Engraulis mordax" ~ (0.0015*(Length^3.37))*Count/1000,
    Taxa=="Clupea pallasii" ~ (0.0015*(Length^3.44))*Count/1000,
    Taxa=="Morone saxatilis" ~ (0.0066*(Length^3.12))*Count/1000))
...
BayStudy_annual_values_final_by_region<-full_join(BayStudy_Midwater_annual_values_CPUE_by_region,
  ...
  full_join(BayStudy_Midwater_annual_values_biomass_by_region, by="Year") %>% full_join(BayStudy_Otter_annual_values_biomass_by_region, by="Year")

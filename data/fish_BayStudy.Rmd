...
BayStudy_Striped_Bass_age0 <-LTMRdata::fish(sources="Baystudy", species="Morone saxatilis", size_cutoff=NULL,remove_unknown_lengths=FALSE) %>%
...
BayStudy_Striped_Bass_large <-LTMRdata::fish(sources="Baystudy", species="Morone saxatilis", size_cutoff=NULL,remove_unknown_lengths=FALSE) %>%
  mutate(Month=month(Date)) %>% left_join(length_cutoff_striped_bass)

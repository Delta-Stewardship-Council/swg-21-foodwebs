...
```{r}
zoop_energy_data<-read.csv("data/zoop_energy_data/zoop_energy_density.csv") %>% 
  mutate(Group = str_replace(group, " Copepoda", "_Copepods")) %>% 
  select(Group, energy_density_j_per_g_wet_mass_mean) %>% 
  rename(energyj_per_g_wet_mass = energy_density_j_per_g_wet_mass_mean)

...
```{r}
df_amph <- read_csv('data/annual_averages/amphipod_annual_regions_salinity.csv', col_types = c(Month = 'd')) %>%
...
```{r}
df_clams <- read_csv('data/annual_averages/clams_annual_regions_salinity.csv', col_types = cols(Month = 'd')) %>%
  rename(Orig_Region = Region)

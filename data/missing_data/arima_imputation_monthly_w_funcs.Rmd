...
temp_imputed <- read_csv("data/missing_data/imputed_data/monthly/temperature_imputed_monthly_data.csv") %>% 
  mutate(Analyte="Temperature")
chl_imputed <- read_csv("data/missing_data/imputed_data/monthly/chlorophyll_imputed_monthly_data.csv")%>% 
  mutate(Analyte="Chlorophyll")
amm_imputed <- read_csv("data/missing_data/imputed_data/monthly/diss_ammonia_imputed_monthly_data.csv")%>% 
  mutate(Analyte="DissAmmonia")
nitr_imputed <- read_csv("data/missing_data/imputed_data/monthly/diss_nitrate_nitrite_imputed_monthly_data.csv")%>% 
  mutate(Analyte="DissNitrateNitrite")
ophos_imputed <- read_csv("data/missing_data/imputed_data/monthly/diss_orthophos_imputed_monthly_data.csv")%>% 
  mutate(Analyte="DissOrthophos")
secchi_imputed <- read_csv("data/missing_data/imputed_data/monthly/secchi_imputed_monthly_data.csv")%>% 
  mutate(Analyte="Secchi")

# combine and pivot
all_imputed <- bind_rows(temp_imputed, chl_imputed, amm_imputed, nitr_imputed, ophos_imputed, secchi_imputed)
View(all_imputed)
summary(all_imputed) # only 50 remaining NAs instead of 323 NAs
...
all_imputed_export_region %>% write_csv("data/missing_data/imputed_data/nutrient_data_monthly_regions_imputed.csv")
all_imputed_export_noregions %>% write_csv("data/missing_data/imputed_data/nutrient_data_monthly_noregions_imputed.csv")

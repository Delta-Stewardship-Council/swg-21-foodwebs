...
## export df
```{r}
df_ts %>% write_csv("data/missing_data/monthly/imputed_data/monthly/temperature_imputed_data.csv")
```
...
## export df
```{r}
df_ts %>% write_csv("data/missing_data/monthly/imputed_data/monthly/chlorophyll_imputed_data.csv")
```
...
## export df
```{r}
df_ts %>% write_csv("data/missing_data/monthly/imputed_data/monthly/diss_ammonia_imputed_data.csv")
```
...
## export df
```{r}
df_ts %>% write_csv("data/missing_data/monthly/imputed_data/monthly/diss_nitrate_nitrite_imputed_data.csv")
```
...
## export df
```{r}
Time_series_imp2 %>% write_csv("data/missing_data/monthly/imputed_data/monthly/secchi_imputed_data.csv")
```
...
temp_imputed <- read_csv("data/missing_data/monthly/imputed_data/monthly/temperature_imputed_data.csv") %>% 
  mutate(Analyte="Temperature")
chl_imputed <- read_csv("data/missing_data/monthly/imputed_data/monthly/chlorophyll_imputed_data.csv")%>% 
  mutate(Analyte="Chlorophyll")
amm_imputed <- read_csv("data/missing_data/monthly/imputed_data/monthly/diss_ammonia_imputed_data.csv")%>% 
  mutate(Analyte="DissAmmonia")
nitr_imputed <- read_csv("data/missing_data/monthly/imputed_data/monthly/diss_nitrate_nitrite_imputed_data.csv")%>% 
  mutate(Analyte="DissNitrateNitrite")
ophos_imputed <- read_csv("data/missing_data/monthly/imputed_data/monthly/diss_orthophos_imputed_data.csv")%>% 
  mutate(Analyte="DissOrthophos")
secchi_imputed <- read_csv("data/missing_data/monthly/imputed_data/monthly/secchi_imputed_data.csv")%>% 

...
model_fits <- eval_fit(chl_table, model_params, monthly = TRUE)
```
...
## export df
```{r}
df_ts %>% write_csv("data/missing_data/imputed_data/monthly/diss_orthophos_imputed_monthly_data.csv")
```
...
temp_monthly_imputed <- read_csv("data/missing_data/imputed_data/monthly/temperature_imputed_monthly_data.csv") %>% 
  mutate(Analyte="Temperature")
chl_monthly_imputed <- read_csv("data/missing_data/imputed_data/monthly/chlorophyll_imputed_monthly_data.csv")%>% 
  mutate(Analyte="Chlorophyll")
amm_monthly_imputed <- read_csv("data/missing_data/imputed_data/monthly/diss_ammonia_imputed_monthly_data.csv")%>% 
  mutate(Analyte="DissAmmonia")
nitr_monthly_imputed <- read_csv("data/missing_data/imputed_data/monthly/diss_nitrate_nitrite_imputed_monthly_data.csv")%>% 
  mutate(Analyte="DissNitrateNitrite")
ophos_monthly_imputed <- read_csv("data/missing_data/imputed_data/monthly/diss_orthophos_imputed_monthly_data.csv")%>% 
  mutate(Analyte="DissOrthophos")
secchi_monthly_imputed <- read_csv("data/missing_data/imputed_data/monthly/secchi_imputed_monthly_data.csv")%>% 

...
df_wq_sub <- df_wq[df_wq$Analyte %in% c('Chlorophyll', 'DissNitrateNitrite', 'DissAmmonia', 'DissOrthophos', 'DissSilica','DOSurf','Salinity','TotPhos','Turbidity','Pheo', 'DON','DissChloride','TurbiditySurface','Secchi','Temperature'),]

...
write.csv((DJFMP_Coords_study_stations_subset_annual %>% mutate(Survey="Delta Juvenile Fish Monitoring Program")),row.names = FALSE,file=file.path("stations/stations_fish_DJFMP_annual.csv"))
...
write.csv((DJFMP_Coords_study_stations %>% mutate(Survey="Delta Juvenile Fish Monitoring Program")),row.names = FALSE,file=file.path("stations/stations_fish_DJFMP_monthly.csv"))
```

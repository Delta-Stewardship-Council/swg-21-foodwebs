...
write.csv((DJFMP_Coords_study_stations %>% mutate(Survey="Delta Juvenile Fish Monitoring Program")),row.names = FALSE,file=file.path("data_stations/Final_stations_fish_DJFMP_monthly.csv"))
```

...
FMWT_regional_values_wide = FMWT_regional_values %>%
  ...
  mutate(FMWT_fish_biomass_Estuarine_pelagic_forage_fishes=sum(FMWT_fish_biomass_AmericanShad,
         ...
         FMWT_fish_catch_per_tow_Estuarine_pelagic_forage_fishes=sum(FMWT_fish_catch_per_tow_AmericanShad,
